  ...
  ?>
    ...
    <nav class=" timeline-yearbar mb-4" aria-label="<?php echo esc_attr__('Thanh năm', 'peugeot-theme'); ?>">
        <ul class="yearbar list-unstyled d-flex flex-wrap gap-2">
            ...
            <li>
                <a href="#<?php echo esc_attr($anchor); ?>" class="year-link btn btn-light btn-sm js-year-link"
                    data-target="<?php echo esc_attr($anchor); ?>">
        ...
        <li id="<?php echo esc_attr($anchor); ?>" class="timeline-item d-md-flex">
            ...
            <div class="timeline-content card shadow-sm">
                ...
                <div class="timeline-body">
                    ...
                    <div class="mt-3">
                        <a href="#top"
                            class="small text-decoration-none js-back-top"><?php echo esc_html__('Về đầu trang', 'peugeot-theme'); ?></a>
                    </div>
                </div>
                <?php if ($it['img']): ?>
                <div class="timeline-media">
                    <img src="<?php echo esc_url($it['img']); ?>"
                        alt="<?php echo esc_attr($it['title'] ?: $it['year']); ?>" loading="lazy" decoding="async">
                </div>
                <?php endif; ?>
            </div>
        </li>
