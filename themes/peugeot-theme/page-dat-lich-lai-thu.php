...
<div class="container-fluid">
    ...
    <form id="test-drive-form" class="acf-form td-grid" method="post">
        ...
        <div class="td-row-2">
            <section class="td-acc td-open td-acc--half">
                <button class="td-acc-head" type="button">
                    <span><?php echo esc_html__('HÃY CHỌN MẪU PEUGEOT PHÙ HỢP VỚI BẠN NHẤT', 'peugeot-theme'); ?></span><i
                        class="td-acc-icon"></i>
                </button>
            ...
            <section class="td-acc td-open td-acc--half">
                <button class="td-acc-head" type="button">
                    <span><?php echo esc_html__('CHỌN CỬA HÀNG / ĐẠI LÝ', 'peugeot-theme'); ?></span><i
                        class="td-acc-icon"></i>
                </button>
                <div class="td-acc-content">
        ...
        <section class="td-acc">
            <button class="td-acc-head" type="button">
                <span><?php echo esc_html__('VUI LÒNG CUNG CẤP THÔNG TIN CỦA BẠN', 'peugeot-theme'); ?></span><i
                    class="td-acc-icon"></i>
            </button>
            <div class="td-acc-content">
                <div class="td-policy">
                    <p><?php echo esc_html__('Vui lòng cho chúng tôi biết thông tin sau để liên hệ với bạn:', 'peugeot-theme'); ?>
                    </p>
                </div>
                <?php
        ...
        <section class="td-acc">
            ...
            <div class="td-acc-content">
                <div class="td-policy">
                    <p><?php echo esc_html__('Thông tin cá nhân của bạn sẽ được xử lý theo Chính sách Bảo mật.', 'peugeot-theme'); ?>
                    </p>
                ...
                <div class="td-policy">
                    <p><?php echo esc_html__('và bằng cách chọn ít nhất một trong các kênh này, tôi đồng ý rằng Peugeot Việt Nam xử lý dữ liệu cá nhân của tôi cho các mục đích tiếp thị, nhận dạng và xác minh, như được mô tả trong Chính sách Cho phép sử dụng Thông tin Cá nhân.', 'peugeot-theme'); ?>
                    </p>

                    <p><?php echo esc_html__('Tôi có quyền rút lại sự đồng ý của mình bất cứ lúc nào (để biết thêm chi tiết, vui lòng xem tại đây). Việc rút lại sự đồng ý sẽ không ảnh hưởng đến tính hợp pháp của việc xử lý dựa trên sự đồng ý trước khi rút lại.', 'peugeot-theme'); ?>
                    </p>
                </div>
                <div class="td-actions"> <button type="submit"
                        class="td-submit"><?php echo esc_html__('XÁC NHẬN YÊU CẦU LÁI THỬ', 'peugeot-theme'); ?></button>
                </div>
            </div>
        </section>
    </form>
