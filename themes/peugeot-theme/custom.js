    ...
    (function() {
        document.querySelectorAll(".peugeot-slider").forEach(function(slider) {
            ...
            if (firstImg && !firstImg.complete) {
                firstImg.addEventListener("load", resizeToActive, {
                    once: true
                });
            }
            resizeToActive();
...
document.querySelectorAll(".peugeot-product-colors").forEach(function(block) {
    ...
    colorItems.forEach(function(item) {
        item.addEventListener("click", function() {
            ...
            colorItems.forEach(function(el) {
                el.classList.remove("active");
            });
...
(function() {
    ...
    window.addEventListener('scroll', window.updateHeaderDark, {
        passive: true
    });
    window.updateHeaderDark();
})();
...
(function() {
    ...
    mainNav.addEventListener('click', (e) => {
        ...
        if (hasMegaPanel(li)) {
            ...
            mainNav.querySelectorAll('li.open').forEach(x => {
